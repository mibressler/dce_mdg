...
const items = [{
  ...
  alternative0: alt0_time_value,
  alternative1: alt1_time_value,
}, {
  attribute: attributes.experience.label,
  alternative0: alt0_experience_value,
  alternative1: alt0_experience_value,
}, {
  attribute: attributes.datashared.label,
  alternative0: alt0_datashared_value,
  alternative1: alt0_datashared_value,
}];
